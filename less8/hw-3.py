...
остановит работу скрипта, введя, например, команду “stop”. При этом скрипт завершается, сформированный список выводится на экран.
        ...
        while True:
            ...
            try:
                if data.isdigit():
                    ...
                    raise OwnExcept('Is string\n\n\t"q" - Exit!')
            except OwnExcept as oe:
                print(oe)


OwnExcept.input_data()
